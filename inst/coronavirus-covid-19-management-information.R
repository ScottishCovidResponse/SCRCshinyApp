...
management.dat <- file_structure(h5filename) %>%
  ...
  dplyr::mutate(dataset = c("nhs.confirmed.dat", "nhs.suspected.dat",
                            "nhs.total.dat",
                            "nhs.testing.dat",
                            "scot.ambulance.dat",
                            "scot.calls.dat",
                            ...
                            "scot.deaths.dat",
                            "scot.discharges.dat", "scot.hospital.dat",
                            "nhs.workforce.dat", "scot.testcum.people.dat",
                            "scot.testcum.tests.dat", "scot.testdaily.dat",
                            "scot.testdaily.total.dat", "special.dat")) %>%
  ...
  dplyr::mutate(title = c(
    ...
    "Numbers of ambulance attendances and number of people taken to hospital with suspected COVID-19 (daily)",
    ...
    "Numbers of people in hospital and in ICU with confirmed or suspected COVID-19 in scotland (daily)",
...
related to Covid-19 (daily)",
    ...
    "Numbers of people in hospital and in ICU with confirmed or suspected COVID-19 in special health board (daily)")) %>%
